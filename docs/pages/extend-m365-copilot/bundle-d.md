---
title: "Bundle D — Declarative Agents with Connectors: Grounding Your Agent"
---

<div data-widget="hero"
     data-badge="Bundle D · Grounding with Connectors"
...
<div data-widget="sectionlabel" data-text="Bundle D · DA with Connectors"></div>

<div data-widget="callout"
     data-type="info"
     data-title="Best for developers focused on grounded responses"
     data-body="Complete &lt;a href='../00-prerequisites/'&gt;Lab E0 — Prerequisites&lt;/a&gt; and &lt;a href='../01-first-agent-new/'&gt;Lab E1 (NEW) — Your First Declarative Agent&lt;/a&gt; first. Choose this bundle if you want the agent to answer from indexed data sources instead of relying only on API actions."></div>
