---
title: "Bundle C — API-Based Declarative Agent: From API to Agent"
---

<div data-widget="hero"
     data-badge="Bundle C · API-Based Agent"
...
<div data-widget="sectionlabel" data-text="Bundle C · API-Based Declarative Agent"></div>

<div data-widget="callout"
     data-type="info"
     data-title="Best for developers who want the fundamentals first"
     data-body="Complete &lt;a href='../00-prerequisites/'&gt;Lab E0 — Prerequisites&lt;/a&gt; and &lt;a href='../01-first-agent-new/'&gt;Lab E1 (NEW) — Your First Declarative Agent&lt;/a&gt; first. Choose this bundle if you want to understand the standard API plugin path before exploring MCP or connector-based grounding."></div>
